...
<script type="text/template" id="tmpl-elementor-kit-panel-content">
	...
	<div id="elementor-panel__editor__help">
		<a id="elementor-panel__editor__help__link" href="{{ tabConfig.helpUrl }}" target="_blank">
			<br />
<b>Fatal error:  Uncaught Error: Call to undefined function __() in /storage/emulated/0/RTN/database/WP/wp-content/plugins/elementor/core/kits/views/panel.php:12
Stack trace:
#0 {main}
  thrown in <b>/storage/emulated/0/RTN/database/WP/wp-content/plugins/elementor/core/kits/views/panel.php on line <b>12<br />
</script>